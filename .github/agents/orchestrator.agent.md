...
- **Planner** — Creates implementation strategies and technical plans from user requirements
- **Coder** — Writes code, fixes bugs, implements logic
- **Tester** — Creates and runs tests to verify functionality
- **Reviewer** — Reviews code for quality, style, and correctness
- **Refactorer** — Improves existing code for readability, performance, and maintainability
- **Designer** — Designs UI/UX, creates mockups, and defines user flows
